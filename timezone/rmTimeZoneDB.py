# Common Timezones for use with RainMachine and OpenWRT TZ env var
# Automatically generated from zoneinfo files by export-common-timezone.py
...
rmTimeZoneDB = {
	...
	"Pacific/Fiji":	"FJT-12FJST,M10.3.1/146,M1.3.4/75",
